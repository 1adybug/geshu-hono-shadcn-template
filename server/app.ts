...
const businessRoutes = honoFactory
    .createApp()
    .use("*", csrf())
    .route("/add-user", addUserRoute)
    .route("/ban-user", banUserRoute)
    .route("/create-first-user", createFirstUserRoute)
    .route("/delete-user", deleteUserRoute)
    .route("/export-user", exportUserRoute)
    .route("/get-current-user", getCurrentUserRoute)
    .route("/get-initialization-status", getInitializationStatusRoute)
    .route("/get-user", getUserRoute)
    .route("/get-user-import-template", getUserImportTemplateRoute)
    .route("/import-user", importUserRoute)
    .route("/login", loginRoute)
    .route("/query-error-log", queryErrorLogRoute)
    .route("/query-geshu-oauth-login-status", queryGeshuOAuthLoginStatusRoute)
    .route("/query-operation-log", queryOperationLogRoute)
    .route("/query-system-settings", querySystemSettingsRoute)
    .route("/query-user", queryUserRoute)
    .route("/send-current-user-phone-number-otp", sendCurrentUserPhoneNumberOtpRoute)
    .route("/send-phone-number-otp", sendPhoneNumberOtpRoute)
    .route("/unban-user", unbanUserRoute)
    .route("/update-current-user-profile", updateCurrentUserProfileRoute)
    .route("/update-system-settings", updateSystemSettingsRoute)
    .route("/update-user", updateUserRoute)
